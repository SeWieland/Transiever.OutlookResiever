...
Outlook access and folder normalization are documented in the [Outlook export guide](../../docs/outlook-export.md).
Repository boundaries are documented in the [architecture guide](../../docs/architecture.md).
